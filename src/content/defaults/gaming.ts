...
export const defaultGamingMain: GamingMainContent = {
  ...
  heroGames: [
    { title: "开放世界动作\n鸣潮 Wuthering Waves", date: "最近记录 今天 14:00", img: covers.waves },
    { title: "魂系探索\n艾尔登法环 Elden Ring", date: "最近记录 2026-06-08", img: covers.elden },
    { title: "夜之城回顾\n赛博朋克 2077", date: "最近记录 2026-06-05", img: covers.cyberpunk }
  ],
  categories: [
    { title: "手游记录", subtitle: "Mobile", img: covers.waves },
    { title: "单机长线", subtitle: "Single Player", img: covers.elden },
    { title: "联动合作", subtitle: "Co-op", img: covers.palworld }
  ],
  recentGames: [
    { title: "鸣潮 Wuthering Waves", tag1: { text: "ACTION", bg: "bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400" }, tag2: { text: "记录中", bg: "bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400" }, barColor: "bg-green-500", time: "今天 14:00", desc: "开放世界", img: covers.waves, rating: "8.8 / 10", review: "适合记录探索、抽卡和角色养成进度。" },
    { title: "艾尔登法环 Elden Ring", tag1: { text: "RPG", bg: "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400" }, barColor: "bg-blue-500", time: "2026-06-08", desc: "单人冒险", img: covers.elden, rating: "9.8 / 10", review: "探索节奏和地图设计依然很耐看。" },
    { title: "赛博朋克 2077", tag1: { text: "STORY", bg: "bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400" }, barColor: "bg-amber-500", time: "2026-06-05", desc: "剧情回顾", img: covers.cyberpunk, rating: "9.0 / 10", review: "适合做剧情杂谈和夜之城截图记录。" }
  ],
  library: [
    {
      id: "wuthering-waves",
    ...
    },
    {
      ...
      description: "长期回顾的开放世界动作 RPG，用来记录 Boss 战、路线和装备搭配。",
